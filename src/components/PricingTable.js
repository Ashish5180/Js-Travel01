        ...
        <table className="w-full table-auto bg-white shadow-lg rounded-lg">
          <thead>
            <tr className="bg-blue-600 text-white">
              ...
              <th className="px-6 py-3">Sedan</th>
              <th className="px-6 py-3">SUV</th>
          ...
          <tbody>
            {pricing.map((item, index) => (
              <tr key={index} className="border-b">
                <td className="px-6 py-3 text-gray-700">{item.route}</td>
                <td className="px-6 py-3 text-blue-600 font-semibold">{item.sedan}</td>
                <td className="px-6 py-3 text-blue-600 font-semibold">{item.suv}</td>
                <td className="px-6 py-3 text-blue-600 font-semibold">{item.tempo}</td>
              </tr>
            ))}
          </tbody>
        </table>
