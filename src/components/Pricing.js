      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 mt-3 text-xl">₹ 7,500</p>
          ...
          >
            ...
            <p className="text-gray-600 mt-3 text-xl">₹ 4,500</p>
          ...
          >
            ...
            <p className="text-gray-600 mt-3 text-xl">₹ 2000 per hour</p>
            <p className="text-gray-500 mt-3 text-sm">Perfect for shorter trips, up to 4 hours</p>
          </motion.div>
        </motion.div>
      </div>
    </section>
