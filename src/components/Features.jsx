      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl sm:text-4xl text-center font-extrabold text-gray-900 py-5">
              Eco-Friendly Cab Features
            </h2>
            <p className="text-base sm:text-lg font-normal text-gray-500 max-w-xl mx-auto">
              Experience a smarter, greener way to travel with our environmentally conscious fleet and innovative features.
            </p>
          </div>
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-10 lg:gap-y-0 lg:flex-nowrap lg:justify-between">
