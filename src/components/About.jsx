            ...
            <div className="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
              <div className="w-full flex-col justify-center items-start gap-8 flex">
                ...
                >
                  ...
                  J S travel Agency is a premier car & buses rental company founded with a vision of becoming a leader in “Ground Transportation Support” for both personal and corporate travel. The company started in June 2008 with the market leader for passive safety support company with 3 Cars at Manesar. Now it comprises fleet of more than 100 cars (Self Owned & Outsourced) & buses in more than 10 cities. 
                  </p>
                </motion.div>
                <motion.div
